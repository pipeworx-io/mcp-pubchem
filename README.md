...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/pubchem_search_by_name \
  -H 'Content-Type: application/json' \
  -d '{"name":"ibuprofen"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/pubchem_search_by_name`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
